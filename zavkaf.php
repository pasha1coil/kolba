    ...
    <form method="POST" action="upload.php" enctype="multipart/form-data">
        ...
        <table>
			...
			<tr>
				...
				<td><input type="number" id="first21" oninput="mult(1,'first21','result21')" placeholder="__________"></td>
				<td>Количество процентов</td>
			...
			<tr class="parent">
			  ...
			  <tr class="box">
				<td>2.7.1</td>
				<td>От 5% до 10%</td>
				<td><input type="number" id="first42" oninput="mult(0.5,'first42','result42')" placeholder="__________"></td>
				<td>Количество процентов</td>
			...
			<tr class="box">
				<td>2.7.2</td>
				<td>От 10% до 20%</td>
				<td><input type="number" id="first43" oninput="mult(1,'first43','result43')" placeholder="__________"></td>
				<td>Количество процентов</td>
			...
			<tr class="box">
				<td>2.7.3</td>
				<td>Свыше 20%</td>
				<td><input type="number" id="first44" oninput="mult(1.5,'first44','result44')" placeholder="__________"></td>
				<td>Количество процентов</td>
