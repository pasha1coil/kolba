    ...
    <form method="POST" action="upload.php" enctype="multipart/form-data">
        ...
        <table>
			...
			<tr class="parent">
			  ...
			  <td td colspan="5">Разработка ООП по программам бакалавриата, специалитета, магистратуры, аспирантуры</td>  
			</tr>
			<tr class="box">
				<td>1.3.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Издание нового авторского (в соавторстве) учебника (учебного пособия) объемом:</td>  
			</tr>
			<tr class="box">
				<td>1.4.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Переиздание авторского (в соавторстве) учебника (учебного пособия) объемом:</td>  
			</tr>
			<tr class="box">
				<td>1.5.1</td>
				<td>Не менее 7 п.л.:</td>
			...
			<tr>
			  ...
			  <tr class="parent">
				...
				<td colspan="5">Издание авторского пособия или методических указаний для самостоятельной работы студентов:</td>
			  </tr>
			  <tr class="box">
				<td>1.7.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Руководство студентами, аспирантами - призерами, победителями олимпиад, конкурсов</td>
			  </tr>
			  <tr class="box">
				<td>1.9.1</td>
				<td>Международных</td>
			...
			<tr>
				...
				<td><input type="number" id="first20" oninput="mult(2,'first20','result20')" placeholder="__________"></td>
			...
			<tr>
				...
				<td><input type="number" id="first21" oninput="mult(2,'first21','result21')" placeholder="__________"></td>
				<td>Количество процентов</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Приглашение в зарубежные вузы и научные центры</td>
			  </tr>
			  <tr class="box">
				<td>1.13.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Издание монографии по направлениям и специальностям Университета</td>
			  </tr>
			  <tr class="box">
				<td>1.15.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Утверждение в ВАК диссертации преподавателя:</td>
			  </tr>
			  <tr class="box">
				<td>2.1.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Научному консультанту преподавателя утвердившего в ВАК:</td>
			  </tr>
			  <tr class="box">
				<td>2.3.1</td>
				<td>Кандидатскую диссертацию</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Награда за участие в научно- исследовательских конкурсах международного, федерального, городского уровня</td>
			  </tr>
			  <tr class="box">
				<td>2.4.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Участие в диссертационных советах университета</td>
			  </tr>
			  <tr class="box">
				<td>2.5.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Подготовка студентов к выступлению на международных, федеральных, региональных и пр. конференциях</td>
			  </tr>
			  <tr class="box">
				<td>2.6.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Доля студентов, участвующих в НИРС (доклады на научных конференциях, семинарах всех уровней; научные публикации; экспонаты и творческие работы, представленные на выставках с участием студентов)</td>
			  </tr>
			  <tr class="box">
				<td>2.7.1</td>
				<td>От 5% до 10%</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Публикация научных статей в индивидуальном порядке:</td>
			  </tr>
			  <tr class="box">
				<td>2.10.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Публикация научных статей в рамках гранта/софинансирования:</td>
			  </tr>
			  <tr class="box">
				<td>2.11.1</td>
				<td>В журнале входящем в список Scopus, Webof Sciens</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Отзыв на автореферат диссертации</td>
			  </tr>
			  <tr class="box">
				<td>2.14.1</td>
				<td>Докторская диссертация</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Официальное оппонирование или написание отзыва ведущей организации</td>
			  </tr>
			  <tr class="box">
				<td>2.15.1</td>
				<td>Докторская диссертация</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Количество студенческих научных проектов, получивших поддержку в грантовых конкурсах разных уровней</td>
			  </tr>
			  <tr class="box">
				<td>2.17.1</td>
				<td>Международных</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Участие в деятельности научно-теоретического журнала «Ученые записки РГГМУ»</td>
			  </tr>
			  <tr class="box">
				<td>2.21.1</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Проведение мероприятий по профессиональной ориентации и привлечению абитуриентов: прирост численности студентов, принятых в текущем учебном году к уровню предыдущего периода на контрактной основе</td>
			  </tr>
			  <tr class="box">
				<td>3.1.1</td>
				<td>От 5% до 10%</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Доля преподавателей, участвующих в студенческих мероприятиях</td>
			  </tr>
			  <tr class="box">
				<td>3.2.1</td>
				<td>От 5% до 10%</td>
				<td><input type="number" id="first71" oninput="mult(2,'first71','result71')" placeholder="__________"></td>
				<td>Количество процентов</td>
			...
			<tr class="box">
				<td>3.2.2</td>
				<td>От 10% до 20%</td>
				<td><input type="number" id="first72" oninput="mult(3,'first72','result72')" placeholder="__________"></td>
				<td>Количество процентов</td>
			...
			<tr class="box">
				<td>3.2.3</td>
				<td>Свыше 20%</td>
				<td><input type="number" id="first73" oninput="mult(4,'first73','result73')" placeholder="__________"></td>
				<td>Количество процентов</td>
			...
			<tr class="parent">
				...
				<td colspan="5">Присуждение призовых мест (1,2,3 место) студентам во внешних, межвузовских спортивных мероприятиях (соревнования, конкурсы, смотры и т.п.)</td>
			  </tr>
			  <tr class="box">
				<td>3.5.1</td>
				<td>1-место/td>
